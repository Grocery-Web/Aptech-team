    ...
    <div class="card-deck hot_deal__card">
        <div class="card mb-4" style="max-width: 540px;">
            <div class="row no-gutters">
                <div class="col-md-4">
                    <img src="https://via.placeholder.com/150px*160px" class="card-img hot_deal__card--img" alt="...">
                </div>
                <div class="col-md-8">
...
<div class="container category">
    ...
    <div class="row">
        <img src="https://via.placeholder.com/340px*200px" alt="">
    </div>
</div>
<!-- End Categories -->
<!-- List items -->
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="newsletter__right">
                <div class="row">
                    <div class="col-md-8">
                        <input class="form-control" type="text" name="newsEmail" placeholder="Địa chỉ Email của bạn">
                    </div>
                    <div class="col-md-3">
                        <a href="">
